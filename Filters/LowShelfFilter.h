...
class LowShelfFilter : private BiquadFilter<T, 1, SampleRate>
{
public:
	LowShelfFilter(void)
...
private:
	void Update(void)
	{
		BiquadFilter<T, 1, SampleRate>::SetLowShelfCoefficients(this, m_CutoffFrequency, m_Gain, m_SlopeFactor);
	}
